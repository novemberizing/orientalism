...
export default class TemplateBook {
    ...
    static html(o) {
        ...
        const body = TemplateBook.body(Object.assign(o, input, twitter, opengraph, scripts, styles));
    ...
    static tag(book, category, section, o) {
        ...
        return `<a href="/orientalism/${o}/" class="${badge} p0 mt-1"><p class="font-weight-bold m0 p0 d-inline">${o}</p></a>`;
    }
    ...
    static body(meta) {
        const data = {
            ...
            sections: meta.books.map(o => TemplateBook.tag(meta.source.book, meta.source.category, meta.source.section, o.book)).join(' ')
        };
